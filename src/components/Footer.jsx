    ...
    <div className=' flex gap-5 w-full h-screen bg-zinc-900 p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='heading'>
          <h1 className='text-[8vw] uppercase leading-none font-bold tracking-tighter -mb-5 '>
            Eye-
          </h1>
          <h1 className='text-[8vw] uppercase leading-none font-bold tracking-tighter -mb-5 '>
            Opening
      ...
      <div className='w-1/2'>
        <h1 className='text-[6.5vw] uppercase leading-none font-bold tracking-tighter -mb-5 '>
          Presentations
        </h1>
